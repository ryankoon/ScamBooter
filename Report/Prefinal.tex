...
\begin{itemize}
  ...
  \item\textbf{ Defense in Depth.} By implementing a Windows service program that launches on startup and restarts our application program, we prevented our application from being terminated by scammers. Our solution by itself is an extra layer of defence for the system in stopping scammers from communicating with users.
  \item\textbf{ Open Design.} We made our source code public on GitHub so that it is available for anyone to evaluate and make more robust. With the rapidly changing threat environment, this will allow us to be more informed about changes to be made increase our system's effectiveness.
\end{itemize}
%===============================
