...
%================================================================================================================
Besides the large scale analysis conducted by researchers from Stony Brook University, there has not been any new academic studies in this area \cite{b2}. However, there has been widespread media coverage of call centre raids \cite{b6}. In fact, the increased in usage of pop-up ad-blockers potentially reduced the likelyhood of preventing exposure to scam websites, one of the entryways into a technical support scam \cite{b7}. Microsoft's Digital Crimes Unit has continued to conduct investigations, collect evidence, and work with law enforcement to combat technical support scams. This year, google has started restricing ads that claim to provide technical support services by starting a verification program to ensure that only legitimate third-party technical support providers are using their advertising platform \cite{b8}. Scammers are developing new ways trick people in making a payment and certainly more effort has been put into blocking websites and ads. However, analysing user behaviour as the last line of defense is not seenin products for the mass market. This could be due to resource limitations of most consumer computers to be able to provide detailed and accurage analysis as well as privacy concerns.
...
The objectives of the adversaries is to convince the victim that their computer is infected by viruses. After gaining the trust of the victim, the adversaries make the victim to pay them for fixing the non-existent problems. 
\subsection{Initial capabilities}
There are various patterns of technique support scams. Most commonly, the adversaries call users, usuallt claiming to be from well-known companies and set up malicious websites or advertisement that tell the user to call technical support numbers. 
\subsection{Capabilities during the attack}
The adversaries ask users to download remote access software and connect to their computers. They are able to open administrative tools to show system "warnings". They can install malwares on user machines, which can cause user machines to crash and monitor and control user activities.
...
\bibitem{b4}"C\# Get Mouse handle (GetRawInputDeviceInfo)", Stack Overflow, 2018. [Online]. Available: https://stackoverflow.com/questions/14584280/c-sharp-get-mouse-handle-getrawinputdeviceinfo. [Nov. 5 2018]
\bibitem{b5}"rvknth043/Global-Low-Level-Key-Board-And-Mouse-Hook", GitHub, 2018. [Online]. Available: https://github.com/rvknth043/Global-Low-Level-Key-Board-And-Mouse-Hook. [Nov. 5 2018]
\bibitem{b6} S. Chabba, “Indian Fake Call Centers Scam Americans Of Millions Of Dollars, 70 Suspects Arrested,” International Business Times, 06-Oct-2016. [Online]. Available: https://www.ibtimes.com/indian-fake-call-centers-scam-americans-millions-dollars-70-suspects-arrested-2427340. [Nov. 9 2018]
\bibitem{b7} Microsoft and TRG, ``Global Tech Support Scam Research - Global Summary, September 2018'',  https://news.microsoft.com/uploads/prod/sites/358/2018/10/Global-Results-Tech-Support-Scam-Research-2018.pdf, Sept. 2018 [Nov. 9 2018]
\bibitem{b8} D. Graff, ``Restricting ads in third-party tech support services", Google, 2018. [Online]. Available: https://www.blog.google/products/ads/restricting-ads-third-party-tech-support-services. [Nov. 10 2018]
