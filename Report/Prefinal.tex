...
The role of the service is to prevent the application from being terminated. It checks the list of running processes at a set interval and restarts scambooter program if the application is not running.
